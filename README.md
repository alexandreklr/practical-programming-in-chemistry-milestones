...
| Week | Milestone                                   | Link                                                                        |      
|------|---------------------------------------------|-----------------------------------------------------------------------------|
| 1    | Github Account Created                      | https://github.com/alexandreklr                                               | 
| 1    | Github Profile Page                         | https://github.com/alexandreklr/alexandreklr                                    |
| 1    | Commit and Push Change from Command Line    | https://github.com/alexandreklr/ppchem/commit/1af2d33d65540a5a8a515545e96ae1e464e08829                |
| 1    | Create a New Branch                         | https://github.com/alexandreklr/ppchem/tree/chemistry            |
| 1    | Create a conda environment                  | https://github.com/alexandreklr/ppchem/blob/main/env.yml      |
| 1    | Fork a Repo                                 | https://github.com/alexandreklr/practical-programming-in-chemistry-milestones |
| 1    | (Optional) Make a Pull Request              | |
| 2    | (Optional) Review a Pull Request            | |
| 4    | Update `env.yml` via a Pull Request         | https://github.com/alexandreklr/practical-programming-in-chemistry-milestones/pull/1#issue-2186595088 |
